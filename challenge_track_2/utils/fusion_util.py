...
class PointCloudToImageMapper(object):
    ...
    def compute_mapping(self, frame_id, camera_to_world, coords, depth=None, intrinsic=None):
        """
        ...
        if self.intrinsics is not None: # global intrinsics
            w, h, fx, fy, hw, hh = self.intrinsics[frame_id]
            intrinsic = make_intrinsic(fx, fy, hw, hh)
